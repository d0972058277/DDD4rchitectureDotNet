...
public class CorrelationService : ICorrelationService
{
    ...
    public CorrelationService(ICorrelationContextFactory correlationContextFactory,
        ICorrelationContextAccessor correlationContextAccessor, IOptions<CorrelationIdOptions> correlationIdOptions)
    {
    ...
    public Guid CorrelationId
    {
        get
        {
            var hadCorrelationId = Guid.TryParse(_correlationContextAccessor.CorrelationContext?.CorrelationId,
